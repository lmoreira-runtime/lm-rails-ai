...
def analyze_cql_query(user_message, extracted_components, generated_query)
    ...
    result_analysis = get_openai_response(my_user_message, my_system_message, "gpt-4o-mini")
...
def reason_on_request_and_mapping(user_input, mapping)
    my_system_message = $reason_on_request_and_mapping
    my_user_message = "**User Request**: #{user_input}\n\n**Mapped Components**: #{mapping}"
    result_reasoning = get_openai_response(user_input, my_system_message, "gpt-4o-mini")
